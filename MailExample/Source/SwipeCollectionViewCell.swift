...
open class SwipeCollectionViewCell: UICollectionViewCell {
    ...
    var indexPath: IndexPath? {
        guard let view = self.superview?.superview as? UICollectionViewCell else { return nil }
        return collectionView?.indexPath(for: view)
...
extension SwipeCollectionViewCell: SwipeControllerDelegate {
    ...
    func swipeController(_ controller: SwipeController, editActionsForSwipeableFor orientation: SwipeActionsOrientation, point: CGPoint) -> [SwipeAction]? {
        guard let collectionView = collectionView, let indexPath = collectionView.indexPathForItem(at: point) else { return nil }
    ...
    func swipeController(_ controller: SwipeController, editActionsOptionsForSwipeableFor orientation: SwipeActionsOrientation, point: CGPoint) -> SwipeOptions {
        guard let collectionView = collectionView, let indexPath = collectionView.indexPathForItem(at: point) else { return SwipeOptions() }
